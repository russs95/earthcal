...
async function addDatecycle() {
    ...
    const payload = {
        ...
        // Extra date parts ensure local normalization stays on the intended day even if the server strips start_local
        date: `${eventLocal.getFullYear()}-${paddedMonth}-${paddedDay}`,
        year: eventLocal.getFullYear(),
        month: eventLocal.getMonth() + 1,
        day: eventLocal.getDate(),
        notes: addDateNote,
        all_day: 0,
        pinned: false,
        emoji: '',
