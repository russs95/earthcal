...
/* ============================================================
   EARTHCAL v1 APIS  | create_my_calendar.php

   Creates (or returns) the default "My Calendar" for a user.
   ------------------------------------------------------------
...
ini_set('error_log', '/var/www/html/api/debug_create_my_calendar.log');

error_log("---- create_my_calendar.php triggered at " . date('c'));
...
$buwana_id = isset($in['buwana_id']) ? (int)$in['buwana_id'] : 0;
...
// -------------------------------------------------------------
// 5. Create or return the default calendar
// -------------------------------------------------------------
try {
    ...
    // 5a. Return existing default if present
    ...
    // 5b. Create default calendar (ensure unique tokens)
