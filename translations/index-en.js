(function () {
    ...
    window.EARTHCAL_INDEX_TRANSLATIONS = {
        ...
        onboarding: {
            ...
            completion: {
                newCalendar: "Your My Calendar is ready, you're subscribed to the public 2025 and 2026 Astronomical Events Calendars, and we added an event for today to celebrate your first login to EarthCal 🎉. Click below to get started.",
                existingCalendar: "Your My Calendar was already waiting for you, so we re-confirmed your Astronomical Events subscriptions and celebration event—everything is ready to explore!",
            },
            tasks: {
                ...
                schedulingAnniversary: "Ensuring your 🎉 EarthCal Anniversary celebration is scheduled",
                anniversaryExisting: "Your celebration event for today was already on the calendar",
                anniversaryCreated: "Added an event for today to celebrate your first login to EarthCal 🎉",
            },
        },
        buttons: {
        ...
        footer: {
            tagline: "EarthCal v1.3.8 by Earthen",
